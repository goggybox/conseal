...
devices.mobile.ios2 = devices.mobile.ios1.map((d) => {
...
devices.mobile.ios3 = devices.mobile.ios2.map((d) => {
...
devices.tablet.ios2 = devices.tablet.ios1.map((d) => {
...
devices.tablet.ios3 = devices.tablet.ios2.map((d) => {
